...
import { ISeoData } from './seo.model';
...
export class SeoService {
  ...
  public setData(data: ISeoData): void {
  ...
  public setKeywords(keywords?: string): void {
    if (Boolean(keywords)) {
      this.meta.updateTag(<MetaDefinition>{ name: 'keywords', content: keywords });
    } else {
  ...
  public setSection(section?: string): void {
    if (Boolean(section)) {
      this.meta.updateTag(<MetaDefinition>{ name: 'article:section', content: section });
    } else {
